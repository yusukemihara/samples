 ...
 * @author  burgetr
 */
public class TestCSSBOX extends javax.swing.JFrame 
{
     ...
     */
    public TestCSSBOX(Element root, URL baseurl, DOMAnalyzer decoder)
    {
        docroot = root;
    ...
    public static void main(String args[]) 
    {
        ...
        try {
            ...
            //Display the result
            TestCSSBOX test = new TestCSSBOX(da.getRoot(), docSource.getURL(), da);
